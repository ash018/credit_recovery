				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Verify &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:history.go(-1)">Back</a>
							</div>
							<div class="tools">
								...
								<div class="form-body" id="productdetail1">
									...
									<?php										
										...
										if(isset($_REQUEST['AssessmentCode'])){
											$AssessmentCode = $_REQUEST['AssessmentCode'];
										}
										$query = " Select T1.*, T2.* From TmpAssessmentAnswer T1
													Inner Join AssessCustomer T2 ON T1.AssessmentCode = T2.AssessmentCode										
											Where T1.AssessmentCode ='$AssessmentCode'
											Order By T1.AssessmentAnswerID ASC
										";
										$result = odbc_exec($connection,$query);	
										$row = odbc_fetch_array($result);										
										$query1 = "Select sum(Q1+Q2+Q3+Q4+Q9+Q10+Q10+Q11+Q12+Q13+Q14+Q15+Q16+Q17+Q18+Q20) AS qTotal From TmpAssessmentAnswer Where AssessmentCode ='$AssessmentCode'";
									...
									<div id="productdetail" style="margin-top: -2%;">
										...
										<table border=2 style="width: 95%">
											...
											<tr><td colspan="3">DownPayment:&nbsp;<?php echo $row['DownPayment']; ?></td></tr>
										...
										<table border=2 style="width: 95%">
											...
											<tr>
												<td><?php echo $x++; ?></td>
												<td><?php echo "Does Customer OR his/her family use Tractor Previously?"; ?></td>
												<td>
												<?php 
													if($row['Q14'] =="2"){
														echo "NO";
...
<script>
	...
	$('#cmd').click(function () {
		doc.fromHTML($('#productdetail').html(), 15, 15, {
			'width': 470,

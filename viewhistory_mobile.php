								...
								<div class="form-body">									
									<div class="form-group">										
										<?php 
											...
											echo $username;
											$query1 = "SELECT * FROM creditrecovery Where UserName = '$username'";
										...
										<table border="1">
											<tr>
												<th>Sl</th><th>Visit Date</th><th>Code</th><th>Proj.</th><th>Commt.</th><th>Collected</th>
											</tr>
										<?php	
										...
										?>
											<tr>
												...
												<td>
													<?php echo $row['projectionamount']; ?>
												</td>
												<td align="center">
													<?php echo $row['comittedamount']; ?>
												</td>
												<td>
													<?php echo $row['actualpaidamount']; ?>
												</td>												
											</tr>
										<?php } ?>

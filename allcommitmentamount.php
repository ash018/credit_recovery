				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<a href="datewise.php"><i class="fa fa-gift"></i>Commitment</a>
							</div>
							<div class="tools">
							...
							<form action="#" id="form_sample_3" method="post" class="form-horizontal" accept-charset="utf-8">							
								<div class="form-body" id="productdetail1">
									...
									<?php
										...
										$query = "SELECT DISTINCT TerritoryName FROM partinformation ORDER BY TerritoryName";
...
jQuery(document).ready(function () {
	jQuery("#btnproduct").on('click', function () {
		...
		({
			type: "POST",
			url: "getAllCommitmentAmount.php",

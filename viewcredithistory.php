				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body form">
							<form id="excel" action="itemexcel.php" method="post" onsubmit='$("#datatodisplay").val( $("<div>").append( $("#newidwisedetail").eq(0).clone()).html() )'>
							...
							<form action="#" id="form_sample_3" method="post" class="form-horizontal" accept-charset="utf-8">							
								<div class="form-body">
									...
									<?php
										include("db.php");										
										$query = "SELECT DISTINCT TTYCode, territoryname FROM creditrecovery ORDER BY territoryname";										
										...
										<div class="col-md-4">
											...
											<?php												
												while($row = odbc_fetch_array($result)) {
													echo "<option value='".$row['TTYCode']."'>".$row['territoryname']."</option>";
												}
											?>								
											</select>
										</div>
								...
								<div style="height: auto;" id="newidwisedetail">
...
jQuery(document).ready(function () {
	jQuery("#btnproduct").on('click', function () {
		...
		({
			...
			{			
				jQuery("#newidwisedetail").html(html);

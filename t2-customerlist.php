										...
										<table class="table table-bordered">
											...
											<tbody>
												<?php
													...
													$query = "SELECT * FROM overduedetail
														WHERE Part='$Part' AND (CMNoInstOD <> 0 AND CMNoInstOD > 2 AND CMNoInstOD<= 4  AND InstSize <> 0)";
												...
												<tr>
													...
													<td><?php echo $row['LMOD']; ?></td>
													<td><?php echo $row['SPLYOD']; ?></td>																									
												</tr>
												<?php } ?>
											</tbody>
										</table>

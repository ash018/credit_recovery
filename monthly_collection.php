				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<a href="datewise.php"><i class="fa fa-gift"></i>Collection</a>
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							...
							<form action="#" id="form_sample_3" method="post" class="form-horizontal" accept-charset="utf-8">							
								<div class="form-body" id="productdetail1">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" readonly name="startdate" id="startdate" value="<?php echo date('Y-m-01'); ?>">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" readonly name="enddate" id="enddate" value="<?php echo date('Y-m-d'); ?>" >
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>											
										...
										<div class="col-md-4">
											...
											<?php												
												while($row= odbc_fetch_array($result)) { 
													echo "<option value='".$row['ITerritoryCode']."'>".$row['TerritoryName']."</option>";
												}
											?>								
											</select>
										</div>
...
jQuery(document).ready(function () {
	jQuery("#btnproduct").on('click', function () {
		...
		({
			type: "POST",
			url: "getMonthlyCollectionHistory.php",

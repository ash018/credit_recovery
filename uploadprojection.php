				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>New Commitment
							</div>
							<div class="tools">
							...
							<?php
								...
								if(isset($_POST["submit"])){
									...
									while(($filesop = fgetcsv($handle, 1000, ",")) !== false){
										$visitdate = $filesop[0];
										$customercode = $filesop[1];
										$customername = $filesop[2];
										$TTYCode = $filesop[3];
										$territoryname = $filesop[4];
										$mobileno = $filesop[5];
										$projectionamount = $filesop[6];
										$installmentsize = $filesop[7];
										$overdueamount = $filesop[8];
										$nextvisitdate = $filesop[9];
										$comittedamount = $filesop[10];
										$actualpaidamount = $filesop[11];
										$remarks = $filesop[12];
										$supports = $filesop[13];
										$UserName = $filesop[14];
										$sql = mysqli_query($link, "INSERT INTO creditrecovery (
											visitdate,
											customercode,
											customername,
											TTYCode,
									...
									if($sql){
										echo "Projection has been inserted successfully . You have inserted ". $c ." recoreds";
									}else{

				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body form">
							<form id="excel" action="itemexcel.php" method="post" onsubmit='$("#datatodisplay").val( $("<div>").append( $("#productdetail1").eq(0).clone()).html() )'>
							...
							<form action="#" id="form_sample_3" method="post" class="form-horizontal" accept-charset="utf-8">							
								<div class="form-body" id="productdetail">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Projection For</label>
										<div class="col-md-4">
											<select class="form-control" name="projectionmonth" id="projectionmonth" required >
											...
											<select class="form-control" name="projectionyear" id="projectionyear" required>
									...
									<?php
										include("db.php");
										$query = "select * from MotorBrInvoicePower..IncentiveTerritory";
...
jQuery(document).ready(function () {
	jQuery("#btnproduct").on('click', function () {
		...
		projectionmonth = jQuery('#projectionmonth').val();
		projectionyear = jQuery('#projectionyear').val();
		ttyname = jQuery('#ttyname').val();		
		jQuery.ajax
		({
			type: "POST",
			url: "getmonthly_projection.php",
			data: {projectionmonth: projectionmonth, projectionyear:projectionyear, ttyname: ttyname},
			cache: false,

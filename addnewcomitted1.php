				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="insertcomitted1.php" method="post" class="form-horizontal" name="myform" accept-charset="utf-8" onsubmit="return checkentries()" >							
								<div class="form-body">
									...
									<div class="form-group" >									
										...
										<div class="col-md-4" id="customerprojectionamount">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="comittedamount" required class="form-control"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" required class="form-control" name="nextvisitdate" >
												<span class="input-group-btn">

				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Insert Questioner 
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="insertquestion.php" method="post" class="form-horizontal" name="myform" accept-charset="utf-8" onsubmit="return checkentries()" >							
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Question Number <span class="required">*</span></label>
										<div class="col-md-4">
											<input type="text" name="QuestionerID" required class="form-control" required />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Question<span class="required">*</span></label>
										<div class="col-md-4">
											<input type="text" name="QuestionerText" required class="form-control" required />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Notes<span class="required">*</span></label>
										<div class="col-md-4">
											<input type="text" name="Notes" required class="form-control" required />
										</div>
									</div>
...
<script type="text/javascript">
	function checkentries(){
		...
		if (x == null || x == "") {
			alert("You Must Click on Go Button");
			return false;
		}else{
			return true;
		}
...
jQuery(document).ready(function () {
	jQuery("#btncustomer").on('click', function () {
		...
		({
			...
			{			
				jQuery("#customerprojectionamount").html(html);

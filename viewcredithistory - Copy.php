						...
						<div class="portlet-body form">
							...
							<form action="#" id="form_sample_3" method="post" class="form-horizontal" accept-charset="utf-8">							
								<div class="form-body" id="productdetail">
									...
									<?php
										include("db.php");										
										$query = "SELECT * FROM territoryinformation";										
										...
										<div class="col-md-4">
											...
											<?php												
												while($row=mysqli_fetch_array($result)) {
													echo "<option value='".$row['TerritoryCode']."'>".$row['TerritoryName']."</option>";
												}
											?>								
											</select>
										</div>
										...
										<div class="col-md-4">
											...
											<?php	
												...
												while($row = odbc_fetch_array($result)) {
													echo "<option value='".$row['Business']."'>".$row['BusinessName']."</option>";													
												}
												*/
											?>								
											</select>
									...
									<hr>
									<div class="form-group">
										<label class="control-label col-md-3">Search Order</label>
										<div class="col-md-4">											
											<span class="input-group-btn">
									...
									<div id="defaultdata" style="display: none">
									<?php
										include("db.php");
										
										$query = "SELECT * FROM OrderInvoiceMaster WHERE Approved = 1";	
...
jQuery(document).ready(function () {
	jQuery("#btnproduct").on('click', function () {
		...
		({
			type: "POST",
			url: "getcredithistory.php",
			data: {startdate: startdate, enddate:enddate, ttyname: ttyname, filter: filter},
			cache: false,
